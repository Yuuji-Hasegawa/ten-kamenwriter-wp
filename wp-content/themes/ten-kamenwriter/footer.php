    ...
    <div class="c-bottom">
      <div class="o-grid o-grid:sitemap">
        <span class="o-stack o-stack:sitemap">
          <a href="<?php echo home_url('/intro/');?>" class="c-link c-link:mapHead"> イントロダクション </a>
          <a href="<?php echo home_url('/feature/');?>" class="c-link c-link:mapChild"> 初めての方へ </a>
          <a href="<?php echo home_url('/profile/');?>" class="c-link c-link:mapChild"> プロフィール </a>
        </span>
        <span class="o-stack o-stack:sitemap">
          <a href="<?php echo home_url('/aboutus/');?>" class="c-link c-link:mapHead"> 仮面ライターとは？ </a>
          <a href="<?php echo home_url('/service/');?>" class="c-link c-link:mapChild"> 10年目の取り組み </a>
          <a href="<?php echo home_url('/company/');?>" class="c-link c-link:mapChild"> 会社情報 </a>
          <a href="<?php echo home_url('/brand/');?>" class="c-link c-link:mapChild"> ブランドポリシー </a>
        </span>
        <span class="o-stack o-stack:sitemap">
          <a href="<?php echo home_url('/records/');?>" class="c-link c-link:mapHead"> これまでの記録 </a>
