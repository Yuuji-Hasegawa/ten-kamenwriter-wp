...
if (function_exists('wpcf7_add_form_tag')) {
    ...
    function wpcf7_checkbox_form_mytag_handler($tag)
    {
        ...
        if ('mycheckbox' == $tag->basetype) {
            $my_type = 'checkbox';
            $my_class = 'input -btn -chk';
        } else {
            $my_type = 'radio';
            $my_class = 'input -btn';
        }
        $wrap_class = 'input-unit';
	...
	<fieldset>
		...
		<table class="form-table">
			<tbody>
				...
				<tr>
					<th scope="row"><?php echo esc_html(__('Field type', 'contact-form-7')); ?>
					</th>
					<td>
						<fieldset>
				...
				<tr>
					<th scope="row"><?php echo esc_html(__('Options', 'contact-form-7')); ?>
					</th>
					<td>
						<fieldset>
							<legend class="screen-reader-text"><?php echo esc_html(__('Options', 'contact-form-7')); ?>
							</legend>
...
<?php
    ...
    add_action('wpcf7_init', 'wpcf7_add_form_tag_pp_acceptance', 10, 0);
