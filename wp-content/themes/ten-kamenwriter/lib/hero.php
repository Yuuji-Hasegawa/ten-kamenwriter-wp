...
function get_hero()
{
    ...
    is_front_page() ? $output .= '<h1 class="c-hero_main">' . get_bloginfo('name') . '</h1><p class="c-hero_tagline">since 2013</p>' : $output .= '<h1 class="c-hero_main c-hero_main:page">' . get_the_title() . '</h1>';
    $output .= '</div></div>';
    return $output;
}
