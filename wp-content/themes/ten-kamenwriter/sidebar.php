<div id="sidebar" class="c-sidebar" aria-hidden="true">
  ...
  <div class="o-cover o-cover:sidebar">
    ...
    <nav class="o-stack o-stack:nav">
      ...
      <a href="<?php echo home_url('/aboutus/');?>"
        class="c-link c-link:nav"> 仮面ライターとは？ </a>
      <a href="<?php echo home_url('/records/');?>"
        class="c-link c-link:nav"> これまでの記録 </a>
    </nav>
    <div class="o-box o-box:sidebar">
      <h2 class="c-heading c-heading:sidebar">関連サイト</h2>
      <div class="o-stack">
    ...
    <footer class="c-bottom c-bottom:sidebar">
      <nav class="o-cluster o-cluster:footer">
        <a href="<?php echo home_url('/company/');?>"
          class="c-link c-link:fnav"> 会社情報 </a>
        <a href="<?php echo home_url('/terms/');?>"
          class="c-link c-link:fnav"> 利用規約 </a>
        <a href="<?php echo home_url('/privacy-policy/');?>"
          class="c-link c-link:fnav"> プライバシーポリシー </a>
        <a href="<?php echo home_url('/inquiry/');?>"
          class="c-link c-link:fnav"> お問い合わせ </a>
      </nav>
      <div class="c-copyright">©︎ kamenwriter.com</div>
    </footer>
  </div>
</div>
